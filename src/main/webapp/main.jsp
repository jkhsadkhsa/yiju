...
<div class="content">
    <div class="width1190">
        <%--【新房推荐】--%>
        <%--FIXME 这里添加跳转事件--%>
        <h2 class="title"><a style="color:#F1323B">❤</a>新房推荐<a href="${pageContext.request.contextPath}/houseController/findAllHouseByType.do?houseType=0">更多&gt;&gt;</a></h2>
        <div class="index-fang-list">
            <%--FIXME 这里使用Foreach循环，从数据库读取房屋信息 --%>
            <%--var 不能使用关键词--%>
            <c:forEach items="${newHouse}" var="nh">
                <dl>
                    <dt><a href="${pageContext.request.contextPath}/houseController/findHouseById.do?houseId=${nh.houseId}"><img src="http://image.cxhit.com/${nh.houseHeadimg}" width="286"
                                         height="188"/></a>
                    </dt>
                    <dd>
                        <h3><a href="${pageContext.request.contextPath}/houseController/findHouseById.do?houseId=${nh.houseId}"></a></h3>
                        <div class="hui">${nh.houseAddress} | ${nh.houseArea} | ${nh.houseDecorate}</div>
                    </dd>
                </dl>
            </c:forEach>
            <div class="clears"></div>
        ...
        <h2 class="title"><a style="color:#F1323B">❤</a>二手房推荐 <a
                href="${pageContext.request.contextPath}/houseController/findAllHouseByType.do?houseType=1">更多&gt;&gt;</a></h2>
        <div class="index-fang-list">
            <c:forEach items="${oldHouse}" var="ohou">
                <dl>
                    <dt><a href="${pageContext.request.contextPath}/houseController/findHouseById.do?houseId=${ohou.houseId}"><img src="http://image.cxhit.com/${ohou.houseHeadimg}" width="286"
                                         height="188"/></a></dt>
                    <dd>
                        <h3><a href="${pageContext.request.contextPath}/houseController/findHouseById.do?houseId=${ohou.houseId}"></a></h3>
        ...
        <h2 class="title"><a style="color:#F1323B">❤</a>租房推荐 <a
                href="${pageContext.request.contextPath}/houseController/findAllHouseByType.do?houseType=2">更多&gt;&gt;</a></h2>
        <div class="index-ershou">
            ...
            <div class="in-er-right">
                <c:forEach items="${rentHouse}" var="rho">
                    <dl>
                        <dt><a href="${pageContext.request.contextPath}/houseController/findHouseById.do?houseId=${rho.houseId}"><img
                                src="http://image.cxhit.com/${rho.houseHeadimg}"
                                style="width: 150px; height: 115px;" width="150" height="115"/></a></dt>
                        <dd>
                            <h3>
                                <a href="${pageContext.request.contextPath}/houseController/findHouseById.do?houseId=${rho.houseId}"></a>
                            </h3>
                            <br>
