            ...
            <div align="center">
                <label class="butt" id="butt">
                    <input type="button" class="member_mod_buttom"
                           onclick="window.location.href = '/pages/verifyApply.jsp'"
                           value="立即申请"/>
                </label>
            </div>
            </c:if>
            ...
            <div align="center">
                <label class="butt" id="butt2">
                    <input type="button" class="member_mod_buttom2"
                           onclick="window.location.href='${pageContext.request.contextPath}/verifyController/removeVerify.do?';alert('删除成功')"
                           value="删除认证"/>
                </label>
            </div>
