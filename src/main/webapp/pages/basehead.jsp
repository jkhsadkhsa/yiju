...
<div class="header">
    <div class="width1190">
        ...
        <div class="fr">
            ...
            <a href="#" style="font-size: 14px" target="_blank"><strong>你好！${userInfor.phone}</strong></a>
            ...
            <a href="${pageContext.request.contextPath}/userInforController/exit.do" style="font-size: 14px"><strong>退出</strong></a> |
