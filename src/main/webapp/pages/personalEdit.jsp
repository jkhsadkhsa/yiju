        ...
        <div class="vip-right">
            ...
            <table class="grinfo">
                ...
                <tr>
                    ...
                    <td width="600px">
                        <input class="inp inw" type="text" id="phone" name="phone" value="${userInfor.phone}" maxlength="14"
                               disabled="disabled">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td height="40px">
                        <input type="radio" value="0" id="rbSex1"
                               name="sex" <c:if test="${userInfor.gender==0}">checked</c:if>>
...
<script>
    $(function () {
        $(".member_mod_buttom").on("click",function () {
            ...
            else if ($("#rbSex2").is(":checked")){
                gender=1;
            }
            var city = $("input[name=city]").val();

        $.ajax({
            url:"${pageContext.request.contextPath}/userInforController/saveEdit.do",
            typ: "post",
            dataType:"json",
            data:{
                phone:phone,
