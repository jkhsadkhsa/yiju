...
public class UserAuth {
    ...
    public UserAuth(int authId, int userId, String userName, int userGender, String userCard, String userCardAddress, String userLiveAddress, String userCarding, String userPropertyimg, int authStatus, int isDelete, long createTime, long updateTime) {
        this.authId = authId;
        this.userId = userId;
    ...
    public UserAuth( int userId, String userName, int userGender, String userCard, String userCardAddress, String userLiveAddress,long createTime, long updateTime) {
        this.userId = userId;
        this.userName = userName;
        this.userGender = userGender;
        this.userCard = userCard;
    ...
    public UserAuth(Integer userId, String card, String cardaddress, String nowaddress) {
        this.userId =userId;
        this.userCard = card;
        this.userCardAddress = cardaddress;
        this.userLiveAddress = nowaddress;
    }
 public UserAuth(Integer userId, String card, String cardaddress, String nowaddress,int authStatus) {
        this.userId =userId;
        this.userCard = card;
        this.userCardAddress = cardaddress;
        this.userLiveAddress = nowaddress;
